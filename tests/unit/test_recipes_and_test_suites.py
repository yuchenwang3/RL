...
def test_nightly_compute_stays_below_2170_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 2170, (
        f"Total GPU hours exceeded 2170: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
